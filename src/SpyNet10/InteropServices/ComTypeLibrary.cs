...
public class ComTypeLibrary
{
    ...
    public SYSKIND Syskind { get { return _typeLibAttr.syskind; } }
    public LIBFLAGS Libflags { get { return _typeLibAttr.wLibFlags; } }
    ...
    private void LoadTypes()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            TYPEATTR typeAttr = pTypeAttr.ToStructure<TYPEATTR>();
