...
public static class CategoryIDs
{
    ...
    public static readonly Guid SolidEdgeAddIn = new(CATID_SolidEdgeAddIn);
    public static readonly Guid SEApplication = new(CATID_SEApplication);
    public static readonly Guid SEAssembly = new(CATID_SEAssembly);
    public static readonly Guid SEMotion = new(CATID_SEMotion);
    public static readonly Guid SEPart = new(CATID_SEPart);
    public static readonly Guid SEProfile = new(CATID_SEProfile);
    public static readonly Guid SEFeatureRecognition = new(CATID_SEFeatureRecognition);
    public static readonly Guid SESheetMetal = new(CATID_SESheetMetal);
    public static readonly Guid SEDraft = new(CATID_SEDraft);
    public static readonly Guid SEWeldment = new(CATID_SEWeldment);
    public static readonly Guid SEXpresRoute = new(CATID_SEXpresRoute);
    public static readonly Guid SEExplode = new(CATID_SEExplode);
    public static readonly Guid SESimplify = new(CATID_SESimplify);
    public static readonly Guid SEStudio = new(CATID_SEStudio);
    public static readonly Guid SELayout = new(CATID_SELayout);
    public static readonly Guid SESketch = new(CATID_SESketch);
    public static readonly Guid SEProfileHole = new(CATID_SEProfileHole);
    public static readonly Guid SEProfilePattern = new(CATID_SEProfilePattern);
    public static readonly Guid SEProfileRevolved = new(CATID_SEProfileRevolved);
    public static readonly Guid SEDrawingViewEdit = new(CATID_SEDrawingViewEdit);
    public static readonly Guid SERefAxis = new(CATID_SERefAxis);
    public static readonly Guid SECuttingPlaneLine = new(CATID_SECuttingPlaneLine);
    public static readonly Guid SEBrokenOutSectionProfile = new(CATID_SEBrokenOutSectionProfile);
    public static readonly Guid SEFrame = new(CATID_SEFrame);
    public static readonly Guid SE2dModel = new(CATID_2dModel);
    public static readonly Guid EditBlockView = new(CATID_EditBlockView);
    public static readonly Guid SEComponentSketchInPart = new(CATID_SEComponentSketchInPart);
    public static readonly Guid SEComponentSketchInAsm = new(CATID_SEComponentSketchInAsm);
    public static readonly Guid SEHarness = new(CATID_SEHarness);
    public static readonly Guid SEAll = new(CATID_SEAll);
    public static readonly Guid SEAllDocumentEnvrionments = new(CATID_SEAllDocumentEnvrionments);
    public static readonly Guid SEDMPart = new(CATID_SEDMPart);
    public static readonly Guid SEDMSheetMetal = new(CATID_SEDMSheetMetal);
    public static readonly Guid SEDMAssembly = new(CATID_SEDMAssembly);
}